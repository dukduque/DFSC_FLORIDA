...
% 9/11/2018 at 0900 UTC
url = 'https://www.nhc.noaa.gov/archive/2017/al11/al112017.wndprb.049.shtml?';
...
% LOCATION       KT                                                   
% CHARLOTTE NC   34  2   6( 8)   X( 8)   X( 8)   X( 8)   X( 8)   X( 8)
% FLORENCE SC    34 13   2(15)   X(15)   X(15)   X(15)   X(15)   X(15)
...
for i = 1:length(latcent)
    ...
    for ii = 1:length(times) % for only probability ranges 1-3
        % pws1(in) vs orlpws(1)
